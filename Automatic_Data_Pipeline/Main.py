from DataExtract import extract_personal_info, extract_personal_connection, extract_personal_id, extract_personal_skill, extract_personal_job, extract_personal_edu, extract_personal_interests
from Crawling import get_multiple_info, get_my_connection
import pandas as pd
...
all_conn_profile = get_multiple_info(id_list)
...
per_skill_dict = extract_personal_skill(all_conn_profile)
...
per_job_dict = extract_personal_job(all_conn_profile)
...
per_edu_dict = extract_personal_edu(all_conn_profile)
...
# Extract personal edu
per_interest_dict = extract_personal_interests(all_conn_profile)
